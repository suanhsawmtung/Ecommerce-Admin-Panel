...
<script>
    export default {
        ...
        methods: {
            onClickFirstPage () {
                this.$emit("customerPageChanged", 1);
            },
            onClickLastPage () {
                this.$emit("customerPageChanged", this.totalPages);
            },
            onClickPreviousPage(){
                this.$emit("customerPageChanged", this.currentPage-1);
            },
            onClickNextPage(){
                this.$emit("customerPageChanged", this.currentPage+1);
            },
            onClickPage(page){
                this.$emit("customerPageChanged", page);
            },
            isPageActive(page){
