<template>
            ...
            <tbody>
                <tr  v-for="product in getProducts" :key="product.id">
                    ...
                    <td class="control btns" >
                        <button @click="showProductBranch('productUpdate')" title="edit"><i class="fa-regular fa-pen-to-square"></i></button>
                        <button @click="$emit('toggle', 'deleteProduct')" title="delete"><i class="fa-regular fa-trash-can"></i></button>
                        <button @click="showProductBranch('productDetail')" title="info"><i class="fa-solid fa-info"></i></button>
                    </td>
                </tr>
            </tbody>
        </table>
 ...
 <script>
    ...
    export default {
        ...
        methods: {
            showProductBranch (status) {
               this.$emit("showProductBranch", status); 
            }
        }
    }
 </script>
